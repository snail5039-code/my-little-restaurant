...
아래는 사용자가 저장해 둔 맛집 목록입니다. 반드시 이 목록 안에서만 골라야 하고, 목록에 없는 가게를 지어내면 안 됩니다.
...
위 요청(기분, 먹고 싶은 것, 날씨 등)에 가장 잘 맞는 가게를 2~3곳 골라주세요. 각 가게마다 왜 추천하는지 짧고 친근한 한국어 반말 아닌 존댓말로 이유를 적어주세요. message에는 전체적인 코멘트를 한두 문장으로 적어주세요.`;
